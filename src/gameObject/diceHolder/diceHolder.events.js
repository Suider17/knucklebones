...
export const DICE_HOLDER_REMOVE_TEMPORARY_DICE =
  "diceHolderRemoveTemporaryDice";

//PointerEvents
export const DICE_HOLDER_HOVER_IN = "diceHolderHoverIn";
export const DICE_HOLDER_HOVER_OUT = "diceHolderHoverOut";
export const DICE_HOLDER_CLICKED = "diceHolderClicked";

//Events with other element
export const DICE_HOLDER_VALUE_ASSIGNED = "diceHolderValueAssigned";
